...
--------------------------------
OBS: Se observar os 2 (dois) arquivos estão com as Middlewares de páginas de erros personalizadas sendo roteados pelo serviço chamado "manutenção". Também a ipWhiteList impedindo a rede fictícia "10.10.0.0/22" de acessar determinado serviço conforme a necessidade. Por último o redirecionamento automático para https através da middleware "redirectscheme". Opinei por logo abaixo do arquivo, deixar a configuração de ingressroute para fazer gerência dessa função.
